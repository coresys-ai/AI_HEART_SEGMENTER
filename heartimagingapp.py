...
def imageInput(src):
    if src == 'Upload your own Image':
        ...
        if image_file is not None:
            ...
            with col2:
                st.image(img_, caption='AI Predicted Output', use_column_width=True)
        ...
        with col2:            
            if image_file is not None and submit:
                ...
                #--Display predicton
                    ...
                    st.image(img_, caption='AI Heart Segmentation Predictions')
                  
def main():
    
    st.image("logo.JPG", width = 500)
    st.title("AI App for 3D Heart MRI Imaging Segmenter")
